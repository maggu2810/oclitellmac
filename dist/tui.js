...
function ProviderCard(props) {
  ...
  return (() => {
    var _el$ = createElement("box"), _el$2 = createElement("text"), _el$3 = createElement("b"), _el$4 = createElement("text"), _el$5 = createElement("text"), _el$6 = createTextNode(` / `), _el$7 = createElement("text"), _el$8 = createTextNode(` used`), _el$9 = createElement("text"), _el$0 = createTextNode(` remaining`), _el$1 = createElement("text"), _el$10 = createTextNode(`Resets `), _el$11 = createTextNode(` (`), _el$12 = createTextNode(`)`), _el$13 = createElement("text"), _el$14 = createTextNode(`Fetched `);
    ...
    insert(_el$3, () => budget.providerName);
    insert(_el$4, () => formatProgressBar(budget.spend, budget.limit));
    insertNode(_el$5, _el$6);
    insert(_el$5, () => formatCurrency(budget.spend), _el$6);
    insert(_el$5, () => formatCurrency(budget.limit), null);
    insertNode(_el$7, _el$8);
    insert(_el$7, () => formatPercent(budget.percentUsed), _el$8);
    insertNode(_el$9, _el$0);
    insert(_el$9, () => formatCurrency(budget.remaining), _el$0);
    insertNode(_el$1, _el$10);
    insertNode(_el$1, _el$11);
    insertNode(_el$1, _el$12);
    insert(_el$1, () => formatRelativeTime(budget.resetAt), _el$11);
    insert(_el$1, () => budget.duration, _el$12);
    insertNode(_el$13, _el$14);
    insert(_el$13, () => formatAbsoluteTimeLocale(budget.lastFetched), null);
    effect((_p$) => {
      ...
      _v$8 !== _p$.h && (_p$.h = setProp(_el$13, "fg", _v$8, _p$.h));
      return _p$;
    }, {
      e: undefined,
      t: undefined,
...
function KeyInfoPanel(props) {
  ...
  return (() => {
    var _el$ = createElement("box"), _el$2 = createElement("text"), _el$3 = createElement("b");
    insertNode(_el$, _el$2);
    setProp(_el$, "flexDirection", "column");
    setProp(_el$, "gap", 1);
    insertNode(_el$2, _el$3);
    insertNode(_el$3, createTextNode(`Key Info`));
    insert(_el$, createComponent2(Show, {
      ...
      get children() {
        return [createComponent2(Show, {
          ...
          get children() {
            return [(() => {
              var _el$5 = createElement("text"), _el$6 = createTextNode(`Budget data parsing error (`), _el$7 = createTextNode(` file`), _el$8 = createTextNode(`)`);
              insertNode(_el$5, _el$6);
              insertNode(_el$5, _el$7);
              insertNode(_el$5, _el$8);
              insert(_el$5, () => props.loadStatus.errorCount, _el$7);
              insert(_el$5, () => props.loadStatus.errorCount !== 1 ? "s" : "", _el$8);
              effect((_$p) => setProp(_el$5, "fg", theme().textMuted, _$p));
              return _el$5;
            })(), (() => {
              var _el$9 = createElement("text");
              insertNode(_el$9, createTextNode(`Check logs for details`));
          ...
          get children() {
            return [(() => {
              ...
              insertNode(_el$1, createTextNode(`No budget data available`));
              effect((_$p) => setProp(_el$1, "fg", theme().textMuted, _$p));
              return _el$1;
            })(), (() => {
              var _el$11 = createElement("text");
              insertNode(_el$11, createTextNode(`Waiting for oclitellmac-server...`));
    ...
    insert(_el$, createComponent2(For, {
      ...
      children: (budget) => createComponent2(ProviderCard, {
        budget,
        get theme() {
          return theme();
        }
    ...
    effect((_$p) => setProp(_el$2, "fg", theme().text, _$p));
    return _el$;
  })();
}
